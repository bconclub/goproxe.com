...
export const INDUSTRIES: Industry[] = [
  ...
  },
  {
    ...
    demo: {
      business: { name: 'Meridian Advisors', initials: 'MA', tagline: 'Advisory · strategy and ops' },
      ...
      inquiries: [
        'Can you take a new brief this week?',
        'Need a discovery call on an ops project.',
        'We are looking for a partner for a 90-day review.',
        'Are you taking on new clients this quarter?',
        'Can someone look at this before Friday?',
        'Need a consult for our leadership team.',
      ],
      aiReplies: [
        'Yes. Two questions: is this a one-off or ongoing, and who decides. Thursday 4pm or Friday 11am are open.',
        'I can book a 20-minute discovery call. What is the work, and is it this week or next?',
        'Got it. A short call to scope it. Tomorrow 4pm or Thursday 11am?',
        'We are. I will book a discovery slot. Are you the person who signs, or should I include someone else?',
        'Yes. I have Thursday 4pm or Friday 11am. Which works?',
        'Yes. Tell me the brief in one line and I will put two slots in front of you.',
      ],
      userReplyPool: [
        'Thursday 4pm works.',
        'This week. Ops review.',
        'Book Thursday 11am.',
        'Yes, include my partner on the call.',
      ],
